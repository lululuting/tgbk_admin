...
import { Modal, Divider, Input, Upload, message, Avatar, Popover, Select } from 'antd';
...
class Contact extends Component {
  ...
  render() {
    ...
    const { form, form: { getFieldDecorator }, user: { userInfo }, isEdit, updateLoading } = this.props;
    const formLayout = {
      labelCol: { span: 4 },
      wrapperCol: { span: 20 },
    }
    ...
    const switchType = (type) => {
      switch (type) {
        ...
        case 'weibo':
          return <Avatar size={28} icon={<WeiboCircleOutlined />} className={classnames("contact-icon weibo")} />;
        case 'github':
